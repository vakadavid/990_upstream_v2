...
/* FORWARD DECLARATION */
/***********************/
/* These prototypes are compatible with your supercalls.c usage and your error trace. */
/* Make sure that your calls to these functions use pointers to the correct struct type (not void **). */
